...
$script="<script type='text/javascript'>
    ...
    $('#Conta_Geral').on('input', function() {
        if ($('#Conta_Geral').val().length >= 2) {
            ...
            //console.log(ano);
            $.getJSON('modules/clientes/Lista_CG.php', {'exp': expr, 'data': ano }, function(infoArtigo) {
	...
	function procurarArtigo(){
		...
		if(!dataIni || !dataFim){
			...
			if(dataIni > dataFim){
				...
				$.getJSON('modules/clientes/tabelaclientes.php',{'dataini':din,'datafim':fin,'cg':Conta_geral,'codigo':Codigo,'tipoPesquisa':tipoPesquisa},function(dataCab){
				$.getJSON('modules/clientes/total.php',{'datafim':fin,'cg':Conta_geral,'codigo':Codigo},function(dataCab2){ 
