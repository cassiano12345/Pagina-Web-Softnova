...
if(isset($_SESSION['user'])){
	...
	$sql_query =" SELECT datadoc, dvc, nrdiario, nrlancto, descmovcnt, nrdocofic, serie, vld, vlc, grupo FROM CTB_MOV M 
WHERE M.CODEMP = '".$_SESSION['codemp']."' and
M.plano  in ('G', 'J')
and M.CG = '" .$cg. "'
AND M.DATAMOV BETWEEN TO_DATE('".$dataini."', 'DD.MM.YYYY') AND TO_DATE('".$datafim."', 'DD.MM.YYYY') 
AND (('" .$tipoPesquisa. "' = '2') or
